...
@Component({
  selector: 'app-show_infos_help_desk',
  templateUrl: './show_infos_help_desk.component.html',
  styleUrls: ['./show_infos_help_desk.component.css']
})
export class show_infos_help_deskComponent implements OnInit {
  @Input() helpdesk:any;
  today: Date;
